             ...
             $count++;
               ...
               $terms = get_the_terms( $post->ID, 'blog-category' );
            	...
            	<div id="post-<?php the_ID(); ?>" class="blog type-blog <?php echo (has_post_thumbnail()) ? "has-thumb" : "no-thumb";?> blog-col-<?php echo $gridcol.' '.$css_class.' '.$date_class; ?>">
                    ...
                    <p class="blog-short-content"><?php echo blog_limit_words( $post->ID, $excerpt, $words_limit, '...'); ?>

                    

                        <a href="<?php the_permalink(); ?>" class="more-link"> <?php _e( 'read more', 'wp-blog-and-widgets' ); ?></a>	</p>
...
<div class="grid-category-post">                       
                        ...
                        <h3><?php echo ($showCategory == 'true' && $cate_name != '') ? $cate_name : ""?></h3>
